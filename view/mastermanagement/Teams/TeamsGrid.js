...
var exp = Ext.create('Ext.data.Store', {
    ...
    fields: ['teamscode','teamsname', 'description'],
    data: [
    { "teamscode":"T001","teamsname":"Team A","description":"Editing the document"},
    { "teamscode":"T002","teamsname":"Team B","description":"Copy editing the document"},
    { "teamscode":"T003","teamsname":"Team C","description":"Proof Reading"},
    { "teamscode":"T004","teamsname":"Team D","description":"Publishing",},
    
     ]
});
Ext.define('MyDesktop.view.mastermanagement.Teams.TeamsGrid', {
