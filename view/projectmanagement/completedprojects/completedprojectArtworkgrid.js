...
Ext.define('MyDesktop.view.projectmanagement.completedprojects.completedprojectArtworkgrid', {
	extend:'Ext.grid.Panel',
	title: 'Artwork',
	alias:'widget.completeprojectArtworkgrid',
	closeAction: 'hide',
	//selModel:sm,
	//width:1040,
	height:225,
	...
	/*this.tbar = Ext.create('Ext.Toolbar', {  
		...
		this.bbar = Ext.create('Ext.PagingToolbar', {
			...
			/*{
                               xtype : 'button',
                               id : 'edit_add_new_artwork_complete',
                               text : 'Insert New Row',
                               pressed:true,
